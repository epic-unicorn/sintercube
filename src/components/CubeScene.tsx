...
export default function CubeScene({ timeLimitMinutes, running, onSolved, onTimeout }: Props) {
  ...
  function renderFaceStickers() {
    ...
    // Pointer/touch interaction must run inside a component mounted in the Canvas
    function PointerInteraction({ groupRef, applyMove }: { groupRef: React.RefObject<THREE.Group>; applyMove: (m: string) => void }) {
